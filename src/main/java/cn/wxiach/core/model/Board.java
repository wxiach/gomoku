...
public class Board {
    ...
    public char[] vector() { return board; }
    public int length() { return board.length; }
    public char get(int index) { return board[index]; }
    public void set(int index, char value) { board[index] = value; }
    ...
    public Color color(int index) { return Color.of(get(index)); }
    public Color color(Point point) { return color(index(point)); }
    public Stone stone(int index) { return Stone.of(point(index), color(index)); }
    public Stone stone(Point point) { return stone(index(point)); }
