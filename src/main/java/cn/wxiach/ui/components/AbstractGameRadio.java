 ...
 */
public abstract class AbstractGameRadio<T> extends JPanel implements EventBusAware {
     ...
     */
    public AbstractGameRadio(String title) {
        // 1. Setup panel layout and title using TitledBorder (Style)
        setupRadioLayout(title);
        // 2. Initialize component logic (Buttons, Listeners, Events)
        initializeComponent();
    }
     ...
     */
    private void setupRadioLayout(String title) {
    ...
    /**
     * Initializes the radio group component.
     * This includes setting up buttons, selecting the default, adding listeners,
    ...
    protected void addButton(JRadioButton button, T value, ButtonGroup group) {
        // Set the button font
        button.setFont(FontAssets.LXGWWenKaiMonoScreen);
